...
const ComingSoon = () => {
    ...
    return (
        <div className="min-h-dvh bg-[#282C33]">
            <Navbar
                logoText={LOGO_TEXT}
                navLinks={NAV_LINKS}
                ...
                activeSection=""
            />
            <main className="flex flex-col items-center justify-center px-4 relative overflow-hidden pt-20 lg:pt-32 min-h-[calc(100dvh-300px)]">
                {/* Decorative Elements */}
