        ...
        <>
            <nav
                className={`${isNavbarOpen ? 'h-dvh' : 'h-auto'
                    } nav lg:h-auto bg-[#282C33] container-1`}
            >
                <div className="nav-container py-4 lg:pt-8 lg:pb-2 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-12">
